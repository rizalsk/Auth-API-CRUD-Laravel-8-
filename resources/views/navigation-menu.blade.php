    ...
    @if(auth()->guard('sanctum')->check())
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('user.list') }}" :active="request()->routeIs('users')">
                            {{ __('User List') }}
                        </x-jet-nav-link>
                    </div>

                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('crud.list') }}" :active="request()->routeIs('users')">
                            {{ __('Crud List') }}
                        </x-jet-nav-link>
                    </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('user.list') }}" :active="request()->routeIs('users')">
                    {{ __('User List') }}
                </x-jet-responsive-nav-link>
        ...
        <div class="w-full">
            <div class="flex justify-between h-16">
                <div class="absolute top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="mx-4 text-sm text-gray-700 underline">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="mx-4 text-sm text-gray-700 underline">Register</a>
                        @endif
                    @endauth
                </div>
            </div>
